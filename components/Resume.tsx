...
const Resume: React.FC = () => {
    return (
        <section id="resume" className="py-20 sm:py-28 bg-white">
            <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-gray-900">
                    My <span className="bg-gradient-to-r from-purple-600 to-yellow-500 text-transparent bg-clip-text">Resume</span>
                </h2>
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl border border-gray-200 p-8">
                <div className="text-center">
                    <div className="mx-auto mb-6 w-20 h-20 rounded-full bg-gradient-to-r from-purple-500 to-yellow-500 flex items-center justify-center text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                    </div>
                    <h3 className="text-2xl font-bold text-gray-800">{PORTFOLIO_DATA.name} — {PORTFOLIO_DATA.title}</h3>
                    <p className="mt-2 text-gray-600">Backend engineer focused on scaling services for hundreds of millions of users, building resilient search systems, and leading cloud migrations (Azure → GCP).</p>
                </div>
                
                <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-sm text-gray-700">
                    <div>
                ...
                <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
                    <a 
                        ...
                        className="w-full sm:w-auto flex items-center justify-center px-6 py-3 bg-gradient-to-r from-purple-600 to-yellow-500 text-white font-semibold rounded-md shadow-md hover:opacity-90 transition-opacity"
                    >
                       <DownloadIcon className="w-5 h-5 mr-2" /> Download Resume
                    </a>
                    <a 
                        href="#"
                        className="w-full sm:w-auto flex items-center justify-center px-6 py-3 bg-white text-gray-800 font-semibold rounded-md shadow-md border border-gray-300 hover:bg-gray-100 transition-colors"
                    >
             ...
             <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                    <h4 className="text-lg font-bold text-gray-800 mb-3">What's Included</h4>
